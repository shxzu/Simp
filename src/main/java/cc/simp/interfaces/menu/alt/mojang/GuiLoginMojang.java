package cc.simp.interfaces.menu.alt.mojang;
...
public class GuiLoginMojang extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        Gui.drawCenteredString(mc.fontRendererObj, "Email & Password", (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), -1);
    ...
    public void initGui() {
        ...
        (this.username = new GuiTextField(100, this.mc.fontRendererObj, this.width / 2 - 50 - 10, sr.getScaledHeight() / 2 - 50, 120, 20)).setFocused(true);
        (this.password = new GuiTextField(100, this.mc.fontRendererObj, this.width / 2 - 50 - 10, sr.getScaledHeight() / 2 - 25, 120, 20)).setFocused(false);
