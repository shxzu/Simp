...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        final int fixedHeight = ((5 + this.minecraftFontRendererObj.FONT_HEIGHT) * 2) + 2;

        drawString(this.minecraftFontRendererObj, EnumChatFormatting.GRAY + (EnumChatFormatting.BOLD + "Version Information"), (width - this.minecraftFontRendererObj.getStringWidth("Version Information")) / 2, fixedHeight, -1);
        drawString(this.minecraftFontRendererObj, versionTitle, (width - this.minecraftFontRendererObj.getStringWidth(versionTitle)) / 2, fixedHeight + this.minecraftFontRendererObj.FONT_HEIGHT, -1);
        drawString(this.minecraftFontRendererObj, versionReleased, (width - this.minecraftFontRendererObj.getStringWidth(versionReleased)) / 2, fixedHeight + this.minecraftFontRendererObj.FONT_HEIGHT * 2, -1);
    ...
    class SlotList extends GuiSlot {
        ...
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(mc.minecraftFontRendererObj,(ViaLoadingBase.PROTOCOLS.indexOf(ViaLoadingBase.getInstance().getTargetVersion()) == i ? EnumChatFormatting.GREEN.toString() + EnumChatFormatting.BOLD : EnumChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5, 0.5, 0.5);
            drawCenteredString(mc.minecraftFontRendererObj, "PVN: " + ViaLoadingBase.getProtocols().get(i).getVersion(), width, (i2 + 2) * 2 + 20, -1);
            GlStateManager.popMatrix();
        }
    }
}
