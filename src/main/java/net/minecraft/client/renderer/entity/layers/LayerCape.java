    ...
    private boolean renderClientCape(AbstractClientPlayer entitylivingbaseIn, float partialTicks) {
        if (entitylivingbaseIn.equals(mc.thePlayer) && Simp.INSTANCE.getModuleManager().getModule(CapesModule.class).isEnabled()) {
            ...
            switch (CapesModule.cape.getValue()) {
                case Simp:
                    this.playerRenderer.bindTexture(new ResourceLocation("simp/images/SimpCape.png"));
                    break;
                case Rise:
                    this.playerRenderer.bindTexture(new ResourceLocation("simp/images/RiseCape.png"));
                    break;
                case Gato:
                    this.playerRenderer.bindTexture(new ResourceLocation("simp/images/GatoCape.png"));
                    break;
                case Minecon:
                ...
                case Kitty:
                    ...
                    break;
                case Blonde:
                    this.playerRenderer.bindTexture(new ResourceLocation("simp/images/BlondeCape.png"));
                    break;
                case OMG:
                    this.playerRenderer.bindTexture(new ResourceLocation("simp/images/OMGCape.png"));
                    break;
            }
            GlStateManager.pushMatrix();
            GlStateManager.translate(0.0F, 0.0F, 0.125F);
