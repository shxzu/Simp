...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            this.field_152323_r.addAll(this.minecraftFontRendererObj.listFormattedStringToWidth(this.field_152326_h.func_152561_a().getFormattedText(), (int)((float)this.width * 0.75F)));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int i = Math.max((int)((double)this.height * 0.85D / 2.0D - (double)((float)(this.field_152323_r.size() * this.minecraftFontRendererObj.FONT_HEIGHT) / 2.0F)), 50);
        this.drawCenteredString(this.minecraftFontRendererObj, this.field_152324_f.getFormattedText(), this.width / 2, i - this.minecraftFontRendererObj.FONT_HEIGHT * 2, 16777215);

        for (String s : this.field_152323_r)
        {
            this.drawCenteredString(this.minecraftFontRendererObj, s, this.width / 2, i, 10526880);
