...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.minecraftFontRendererObj, this.field_146394_i, i, 32, 16777215);
        this.drawString(this.minecraftFontRendererObj, this.field_146391_r, i + 2 + 213 - this.minecraftFontRendererObj.getStringWidth(this.field_146391_r), 32, 16777215);
    ...
    class Details extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiCreateFlatWorld.this.minecraftFontRendererObj.drawString(s, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 16777215);
            String s1;
            ...
            GuiCreateFlatWorld.this.minecraftFontRendererObj.drawString(s1, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.minecraftFontRendererObj.getStringWidth(s1), p_180791_3_ + 3, 16777215);
        }
