...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_175317_i = new GuiTextField(2, this.minecraftFontRendererObj, 50, 40, this.width - 100, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.minecraftFontRendererObj, this.field_175315_a, this.width / 2, 8, 16777215);
        this.drawString(this.minecraftFontRendererObj, this.field_175313_s, 50, 30, 10526880);
        this.drawString(this.minecraftFontRendererObj, this.field_175312_t, 50, 70, 10526880);
    ...
    class ListPreset extends GuiSlot
    {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiScreenCustomizePresets.this.minecraftFontRendererObj.drawString(guiscreencustomizepresets$info.field_178955_a, p_180791_2_ + 32 + 10, p_180791_3_ + 14, 16777215);
        }
    }
}
