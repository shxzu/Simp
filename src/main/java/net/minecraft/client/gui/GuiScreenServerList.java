...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146302_g = new GuiTextField(2, this.minecraftFontRendererObj, this.width / 2 - 100, 116, 200, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.minecraftFontRendererObj, I18n.format("selectServer.direct", new Object[0]), this.width / 2, 20, 16777215);
        this.drawString(this.minecraftFontRendererObj, I18n.format("addServer.enterIp", new Object[0]), this.width / 2 - 100, 100, 10526880);
